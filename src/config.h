...
#define CFG_BINDS                                                              \
    ...
    {MODKEY, XK_Return, 0, {.cmd = build_argv("alacritty")}, TYPE_CMD},        \
        {MODKEY, XK_w, 0, {.cmd = build_argv("firefox")}, TYPE_CMD},           \
        ...
        {MODKEY, XK_j, 0, {.fn = focus_up}, TYPE_FUNC},                        \
        {MODKEY, XK_k, 0, {.fn = focus_down}, TYPE_FUNC},                      \
        {MODKEY, XK_h, 0, {.fn = focus_left}, TYPE_FUNC},                      \
        {MODKEY, XK_l, 0, {.fn = focus_right}, TYPE_FUNC},                     \
        {MODKEY | ShiftMask, XK_j, 0, {.fn = move_focused_up}, TYPE_FUNC},     \
        {MODKEY | ShiftMask, XK_k, 0, {.fn = move_focused_down}, TYPE_FUNC},   \
        {MODKEY | ShiftMask, XK_h, 0, {.fn = move_focused_left}, TYPE_FUNC},   \
