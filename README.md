...
All configuration of tilite is done at compile time in the config.h header. The config on this repo is my personal one but I'll add more generic ones in the future.
